...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/img_Remove_inventory_item_img'))
...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_lastName'), 'Nia')
